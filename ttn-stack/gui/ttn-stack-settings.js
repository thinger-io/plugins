'use strict';
angular.module('TTNStackPlugin', ['uiAce'])
    .directive('ttnStackSettings', function(){
    return {
        restrict: 'EA',
        scope: {
            plugin : '='
        ...
        templateUrl: function(){
            let url = document.querySelector("script[src$='ttn-stack-settings.js']");
        ...
        controller: ['$scope', function($scope){
            ...
            $scope.plugin.getToken('ttn_stack_plugin_callback').then(function(token) {
                $scope.ttn_stack_plugin_callback = token.access_token;
            },function error(){
                $scope.ttn_stack_plugin_callback = 'Token not found!';
            });
